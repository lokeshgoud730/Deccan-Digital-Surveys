                ...
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-3 border border-slate-300 dark:border-zinc-700 rounded-xl bg-slate-50 dark:bg-zinc-800 dark:text-zinc-100 text-base focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none transition-all"
                    />
                  </div>
                </div>
